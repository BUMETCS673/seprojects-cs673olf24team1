...
export const API_BASE_URL = 'http://54.159.232.88:8080/api/v1'; // Primary API base URL
export const API_BASE_URL2 = 'http://54.159.232.88:5000/api'; // Secondary API base URL
export const REACT_API_BASE_URL1 = API_BASE_URL2; // Use environment variable or fallback
export const REACT_API_BASE_URL2 = API_BASE_URL; // Use environment variable or fallback
